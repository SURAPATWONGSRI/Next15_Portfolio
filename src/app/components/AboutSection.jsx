  ...
  },
  {
    ...
    content: (
      <ul>
        ...
        <li>
          มหาวิทยาลัยเทคโนโลยีราชมงคลธัญบุรี | 5 กรกฎาคม 2564 - 24 มีนาคม 2568
        </li>
  ...
  },
  {
    ...
    content: (
      <ul>
        ...
        <li>บริษัท บีแทสก์ คอนซัลติ้ง จำกัด | 07/2567 - 10/2567</li>
        <li className="text-md">
          หน้าที่ :{" "}
          <span>
    ...
    <section className="text-white">
      <div className="flex flex-col md:grid md:grid-cols-2 gap-6 md:gap-8 items-center py-6 md:py-8 px-3 md:px-4 xl:gap-16 sm:py-16 xl:px-16">
        ...
        <div className="mt-4 md:mt-0">
          ...
          >
            ผมจบการศึกษาในระดับปริญญาตรีที่มหาวิทยาลัยเทคโนโลยีราชมงคลธัญบุรี
